...
const url = "https://rakeshkanna-rk.github.io/database/portfolio/freebies.json";
const { data: links, isLoading, error } = useFetchData(url, "freebies");

useHead({
  title: "Rakesh Kanna | Freebies",
});
</script>
